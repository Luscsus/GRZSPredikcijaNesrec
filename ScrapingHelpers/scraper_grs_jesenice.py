...
def scrape_grs_jesenice():
    site_name = "grs-jesenice"
    base_url = "http://www.grs-jesenice.org/novice.php?pid={}"
    max_pid = 441
    posts = []
    ...
    for pid in range(max_pid, 0, -1):
        ...
        try:
            ...
            if author_div:
                ...
                # Example: Objavil/a: <b>Marko Štojs</b>, <b>četrtek, 10. april 2025</b>, ...
